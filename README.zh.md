...
**用户：**我要买个旅行箱，你告诉我一下哪个最好？

**$task-clarifier：**“最好”的旅行箱取决于具体使用场景和优先级，现在信息还不够完整。我先问三个关键问题：

**Q1. 你主要用这个旅行箱做什么？使用频率怎样？**

这决定了对耐用性、尺寸和功能的要求。比如短途出差和长期海外工作的箱子需求完全不同。

A) 短途出差（1-3天，一年几次）　B) 度假旅游（1-2周，一年1-2次）　C) 长期出行或背包客（持续数周以上）　D) 日常使用频繁（几乎每月用）　E) 告诉我你的想法

→ 我的建议：先确认主要场景，这决定了对轻便度和耐用性的平衡。

**Q2. 你的预算范围是多少？**

旅行箱从几百块到几千块差异很大，这直接决定了品牌和功能的可选范围。

A) 500元以内　B) 500-1500元　C) 1500-3000元　D) 3000元以上　E) 告诉我你的想法

→ 我的建议：中档预算（1000-2000元）通常能兼顾耐用性和轻便性。

**Q3. 对旅行箱，你最在乎什么？**

A) 轻便易携带　B) 耐用不容易坏　C) 容量大能装　D) 价格便宜　E) 品牌/外观　F) 告诉我你的想法

→ 我的建议：根据场景选择。如果是短途出差选轻便，如果是长期海外选耐用。

**用户：**商务出差，预算 1000-1500 元，优先耐用。

**$task-clarifier：**信息更清晰了。短途出差、预算 1000-1500 元、优先耐用性，这个场景有明确方向。我再问两个关键点：

**Q1. 你的出差地点是国内还是国际？箱子需要能上飞机吗？**

A) 国内出差，20寸足够（能上飞机）　B) 国内出差，无所谓尺寸　C) 国际出差，需要20寸　D) 告诉我你的想法

→ 我的建议：如果有上飞机的可能，选20寸会更灵活。

**Q2. 对箱子材质，你有偏好吗？**

A) 硬壳（PC/ABS材质，更耐用，但重一些）　B) 软壳（布料，轻便，对冲击敏感）　C) 无所谓　D) 告诉我你的想法

→ 我的建议：既然耐用优先，硬壳会更符合你的需求。

**用户：**国际国内通用，28寸；硬壳。

**$task-clarifier：**这里有一个需要澄清的矛盾：你说主要用于短途出差（1-3天），但选择了 28 寸大箱子。28 寸通常用于长期出行或一次装很多东西；短途出差一般 20-24 寸就够了。

**Q1. 你选 28 寸的真实原因是什么？这直接影响最终推荐。**

A) 其实我出差时间不只1-3天，有时候1-2周　B) 短途出差居多，但偶尔需要一个大箱子装更多东西，想一箱多用　C) 就是想买个大的，备用　D) 告诉我你的想法

→ 我的建议：如果是一箱多用，28寸很合适；如果真的只是1-3天短途，20-24寸会更轻便。

**Q2. 你对箱子的其他功能有要求吗？**

A) 基础功能就行，耐用最重要　B) 需要防盗拉链　C) 需要可扩展隔层　D) 其他（告诉我）

→ 我的建议：既然耐用优先，基础功能达标就行；知名品牌的中端硬壳款通常够用。

**用户：**一箱多用，基础功能就行。

**$task-clarifier：**现在信息完整了。
...
- 你对箱子轮子的顺滑度和拉杆手感有一定要求，因为出差频繁意味着反复推拉。
- 你想一次买到位，不打算频繁换箱子，所以耐用性是核心评估标准。
- 你偏向选择知名品牌，因为这个价位段内的硬壳箱质量和售后更稳定。

确认后，agent 可以给出 3-4 个具体产品推荐，包括品牌、型号、价格和推荐原因。
